...
(function ($) {
  ...
  function yose_navigation() {
    ...
    $(document).on("click touchstart", function (e) {
      if (
        $siteMenuBody.is(e.target) ||
        $(e.target).closest(".site-menu").hasClass("site-menu") ||
  ...
  function yose_navChangeClasses(nav_event) {
    if (
      ...
      !(nav_event == "" || nav_event == undefined || nav_event == "resize")
    )
      return;
  ...
  function yose_slider() {
    ...
    if ($slider.length > 0) {
      ...
      if (
        ...
        $slider.hasClass("slick-destroy-xl")
      ) {
      ...
      if (
        991 >= getWindowWidth() &&
        $slider.hasClass("slick-initialized") &&
        $slider.hasClass("slick-destroy-lg")
      ) {
        $slider.slick("unslick");
      }
      ...
      if (
        767 >= getWindowWidth() &&
        $slider.hasClass("slick-initialized") &&
        $slider.hasClass("slick-destroy-md")
      ) {
        $slider.slick("unslick");
      }
      ...
      if (
        575 >= getWindowWidth() &&
        $slider.hasClass("slick-initialized") &&
        $slider.hasClass("slick-destroy-sm")
      ) {
        $slider.slick("unslick");
      }
    }
